...
@section('content')
    ...
    @endif
    <form action="{{ route('register') }}" method="POST" class="col d-flex flex-column align-items-center needs-validation"
        novalidate>
        @csrf
        <div class="body d-flex flex-column justify-center align-items-center" style="width: 310px; margin-top: 20%;">
            ...
            <a class="link-primary" href="{{ route('signin') }}">Sign in</a>
        </div>
    </form>
@endsection
