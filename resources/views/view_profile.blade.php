...
<div class="mt-5 text-center">
    ...
    <img class="round mt-4" style="width: 242px; height: 242px; border-radius: 50%;" src="{{url('/assets/icon/cat.png')}}" alt="" class="rounded-circle me-2">

    <div class="mb-4" style="margin-left: 12%; z-index:2;">
