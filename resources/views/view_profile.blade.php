...
<div class="mt-5 text-center">
    ...
    <form action="{{route('edit_profile', ['user' => $user])}}" method="post" enctype="multipart/form-data">
        ...
        <div class="container mb-3" style="position: relative;">
            ...
            <a class="btn p-0 cursor" style="border:none; top: 85%; left: 56%; position:absolute;">
                <div class="input-group cursor">
                    <label for="image" class="image-label cursor">
        ...
        <div class="d-flex align-items-center justify-content-center mt-5">
            ...
            <input type="text" class="form-control" name="name" value = "{{$user->name}}" style="width: 251px; height: 45px;" name>    
        </div>
        <div class="mt-5">
