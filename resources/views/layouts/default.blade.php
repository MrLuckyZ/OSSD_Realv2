       ...
       <nav class="ps-2 d-flex navbar navbar-light bg-white sticky-top">
                                    ...
                                    <div class="row custom-table" style="border: none">
                                        <div class="col">
                                            <li class="d-flex align-items-center mt-1 link-black" style="height: 30px">
                                                <a class="link-black" style="width: 100%; height:100%" href="{{ route('workspace.index', ['workspace' => $workspace['id_workspace']]) }}">
                                                    ...
                                                    <label label class="fs-6 fw-normal cursor" for="">{{ $workspace['workspace_name'] }}</label>
                                                </a>
                                            </li>
                                        </div>
                                    </div>
        ...
        <div class="dropdown pe-5 fs-5">
            ...
            <ul class="dropdown-menu pane" aria-labelledby="dropdownMenuButton1">
                ...
                <li><a class="dropdown-item" href="{{ route('active/login/logout', ['id' => Auth::user()->id]) }}">Activity Log</a></li>
                <li>
