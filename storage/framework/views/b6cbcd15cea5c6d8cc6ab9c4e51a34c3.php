...
<?php $__env->startSection('content'); ?>
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('register')); ?>" method="POST" class="col d-flex flex-column align-items-center needs-validation" novalidate>
        <?php echo csrf_field(); ?>
        <div class="body d-flex flex-column justify-center align-items-center" style="width: 310px; margin-top: 20%;">
            ...
            <div class="input-group mb-4">
                ...
                <input class="textfield form-control" style="padding-left: 40px; height: 45px; width: 100%; border-radius: 5px;" type="text" name="name" id="name"  placeholder="Enter your full name" required>
            ...
            <div class="input-group mb-4">
                <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="icon me-2 mt-2" viewBox="0 0 16 16" width="16" height="16"><path d="M4 4a4 4 0 0 1 8 0v2h.25c.966 0 1.75.784 1.75 1.75v5.5A1.75 1.75 0 0 1 12.25 15h-8.5A1.75 1.75 0 0 1 2 13.25v-5.5C2 6.784 2.784 6 3.75 6H4Zm8.25 3.5h-8.5a.25.25 0 0 0-.25.25v5.5c0 .138.112.25.25.25h8.5a.25.25 0 0 0 .25-.25v-5.5a.25.25 0 0 0-.25-.25ZM10.5 6V4a2.5 2.5 0 1 0-5 0v2Z"></path></svg>
                <input class="textfield form-control" style="padding-left: 40px; height: 45px; width: 100%; border-radius: 5px;" type="password" name="confirm_password" id="confirm_password"  placeholder="Confirm your password" required>
                <i class="bi bi-eye-slash icon" style="margin-left: 85%; margin-top: 6px;" id="confirm-password-icon" onclick="togglePasswordVisibility('confirm_password', 'confirm-password-icon')">
                    <input type="checkbox" name="" id="confirm-password-visibility" class="visually-hidden">
                </i>
                <div class="invalid-feedback">Please fill your password.</div>
            </div>
            <button class="btn btn-primary" style="font-weight:400; height: 45px;" onclick="bootstrapAlert()" type="submit">Create your account</button>
...
<?php echo $__env->make('layouts.auth_default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/OSSD_Realv2/resources/views/auth/signup.blade.php ENDPATH**/ ?>