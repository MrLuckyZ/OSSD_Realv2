...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col d-flex flex-column align-items-center">
        <form action="<?php echo e(route('login')); ?>" method="POST" class="body d-flex flex-column justify-center align-items-center needs-validation" style="width: 310px; margin-top: 20%;" novalidate>
            <?php echo csrf_field(); ?>
            ...
            <div class="d-flex p-0 mb-3" style="width: 100%;">
                ...
                <div class="col d-flex align-items-center">
                    <a class="link-grey" style="font-size: 14px; font-weight:400;" href="<?php echo e(route('forgot')); ?>">Forgot your password?</a>
                </div>
            </div>
...
<?php echo $__env->make('layouts.auth_default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MrLucky\Desktop\Try\OSSDProject\OSSD_Realv2\resources\views/auth/signin.blade.php ENDPATH**/ ?>