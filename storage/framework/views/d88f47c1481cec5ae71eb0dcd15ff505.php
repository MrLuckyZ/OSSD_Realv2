    ...
    <div class="col d-flex flex-column align-items-center">
        <div class="body d-flex flex-column justify-center align-items-center" style="width: 310px; margin-top: 20%;">
            ...
            <div class="input-group mb-4">
                ...
                <input class="textfield" style="padding-left: 40px; height: 45px; width: 100%; border-radius: 5px;"
                    type="text" name="" id="" placeholder="Enter your email">
            </div>

            <button class="btn btn-primary" style="font-weight:400; height: 45px;" type="submit">Reset your
                password</button>
...
<?php echo $__env->make('layouts.auth_default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MrLucky\Desktop\Try\OSSDProject\OSSD_Realv2\resources\views\Auth\forgot_password.blade.php ENDPATH**/ ?>