        ...
        <div class="row">
            ...
            <div class="col">
                ...
                <div class="col d-flex flex-column align-items-center">
                    <form action="<?php echo e(route('reset.password.post')); ?>" method="POST" class="body d-flex flex-column justify-center align-items-center needs-validation" style="width: auto; margin-top: 20%;" novalidate>
                        <?php echo csrf_field(); ?>
                        <input type="text" name="token" hidden value="<?php echo e($token); ?>">
                        <input type="email" name="email" hidden value="<?php echo e($email); ?>">
...
<?php /**PATH C:\xampp\htdocs\OSSD_Realv2\resources\views/new-password.blade.php ENDPATH**/ ?>