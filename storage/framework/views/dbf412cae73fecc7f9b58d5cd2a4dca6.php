            ...
            <div class="d-flex">
                ...
                <label id="roles" class="btn btn-outline d-flex p-0 cursor" for="public" style="width:400px; height:60px;">
                    ...
                    <div class="col-10 d-flex flex-column justify-content-center" style="width:250px">
                        ...
                        <label id="type" for="public" class="cursor text-center" style="color:#808080; font-size:12px;">Public</label>
                    </div>
                </label>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\MrLucky\Desktop\Try\OSSDProject\OSSD_Realv2\resources\views/setting_work.blade.php ENDPATH**/ ?>