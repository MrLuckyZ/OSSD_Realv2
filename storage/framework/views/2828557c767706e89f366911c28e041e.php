...
<?php $__env->startSection('content'); ?>
    <section class="content d-flex flex-row" style="min-height: 1200px; overflow-y: auto;">
        ...
        <div style="width: 280px; border-right: #f2f2f2 solid 1px;">
            ...
            <?php if($selectedWorkspace->access == 'personal'): ?>
            ...
            <?php elseif($selectedWorkspace->access == 'team'): ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\OSAD\Click_Next2\test\OSSD_Realv2\resources\views/collection.blade.php ENDPATH**/ ?>